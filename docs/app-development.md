...
| 도구 | 설명 |
|------|------|
| `invoke('yaar://windows/{id}', { action: 'app_query', key })` | 상태 키로 앱의 구조화된 데이터 읽기 (`"manifest"`로 매니페스트 조회). Legacy: `app_query` |
| `invoke('yaar://windows/{id}', { action: 'app_command', command, params })` | 앱에 명령 실행. Legacy: `app_command` |
...
- `invoke('yaar://config/app/moltbook', { config: { api_key: "..." } })` — 저장 (legacy: `set_config(section: "app", ...)`)
- `read('yaar://config/app/moltbook')` — 읽기 (legacy: `get_config(section: "app", ...)`)
- `delete('yaar://config/app/moltbook')` — 삭제 (legacy: `remove_config(section: "app", ...)`)
...
| Tool | Description |
|------|-------------|
| `invoke('yaar://windows/{id}', { action: 'app_query', key })` | Read structured data from app by state key (use `"manifest"` to discover capabilities). Legacy: `app_query` |
| `invoke('yaar://windows/{id}', { action: 'app_command', command, params })` | Execute a command on the app. Legacy: `app_command` |
...
- `invoke('yaar://config/app/moltbook', { config: { api_key: "..." } })` — save (legacy: `set_config(section: "app", ...)`)
- `read('yaar://config/app/moltbook')` — read (legacy: `get_config(section: "app", ...)`)
- `delete('yaar://config/app/moltbook')` — remove (legacy: `remove_config(section: "app", ...)`)
