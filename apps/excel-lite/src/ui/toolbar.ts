    ...
    <div class="toolbar">
      <div class="toolbar-row file">
        <button
          ...
          title="Save workbook XLSX to YAAR storage"
        ...
        <button
          ...
          title="Open workbook from YAAR storage (XLSX/JSON)"
        ...
        <button
          ...
          title="Copy sheet JSON to clipboard"
        ...
        <button
          ...
          title="Paste sheet JSON from a dialog"
      ...
      <div class="toolbar-row edit">
        <button class="y-btn y-btn-sm" onClick=${() => undo()} title="Undo" aria-label="Undo">
          ↶
        </button>
        <button class="y-btn y-btn-sm" onClick=${() => redo()} title="Redo" aria-label="Redo">
          ↷
        </button>
        <div
          class="name"
