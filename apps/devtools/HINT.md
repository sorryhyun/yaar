...
Do NOT read source code or attempt fixes yourself — always delegate development work to devtools. App source is not reachable via `yaar://storage/` or `yaar://apps/`; only devtools can clone it.
