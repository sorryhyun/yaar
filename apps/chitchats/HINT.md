...
time. Its `addCharacter` command casts someone on request ("make me a grumpy pirate") and
the prompt written there becomes that character's system prompt verbatim.
