...
/**
 * App shell: sidebar toggle, toolbar, the cell list, and the status bar.
 * Layout is absolute positioning throughout, not flex chains — Solid's `html`
 * inserts comment markers into reactive slots and breaks `flex: 1`.
 */
