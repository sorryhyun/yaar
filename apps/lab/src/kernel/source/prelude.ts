// KERNEL PART 1/12 — limits, shared run state, the AsyncFunction constructor.
...
var __labS = { logs: [], parts: [], lastChart: null, lastGraph: null, pending: Object.create(null), nextCallId: 1 };
