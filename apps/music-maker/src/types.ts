...
export type TrackKey = 'kick' | 'snare' | 'hihat' | 'perc';
...
export type StepSettingsPattern = Record<TrackKey, StepSettings[]>;
export type TrackSettings = Record<TrackKey, { volume: number; muted: boolean; solo: boolean }>;
...
export interface PatternSnapshot {
  ...
  stepSettings: StepSettingsPattern;
...
export const SCALE_LABELS: Record<ScaleType, string> = {
  major: 'Major', minor: 'Minor', pentatonic: 'Pentatonic', blues: 'Blues', dorian: 'Dorian', mixolydian: 'Mixolydian',
};
