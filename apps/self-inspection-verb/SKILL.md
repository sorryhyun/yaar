...
describe('yaar://monitors')
describe('yaar://user/notifications')
describe('yaar://apps')
describe('yaar://agents')
...
```
invoke('yaar://monitors/0/si-v-md', { action: "create", title: "Test: Markdown", width: 300, height: 200, renderer: "markdown", content: "# Markdown\n\n**Bold** and *italic*." })
invoke('yaar://monitors/0/si-v-html', { action: "create", title: "Test: HTML", width: 300, height: 200, renderer: "html", content: "<div style='padding:16px'><h2>HTML</h2><p style='color:green'>Styled content.</p></div>" })
invoke('yaar://monitors/0/si-v-text', { action: "create", title: "Test: Text", width: 300, height: 200, renderer: "text", content: "Plain text content.\nLine 2.\nLine 3." })
invoke('yaar://monitors/0/si-v-comp', { action: "create_component", title: "Test: Component", width: 300, height: 200, components: [{ "type": "text", "content": "Component DSL", "variant": "heading" }, { "type": "badge", "label": "OK", "variant": "success" }, { "type": "progress", "value": 75, "label": "Progress" }] })
invoke('yaar://monitors/0/si-v-tbl', { action: "create", title: "Test: Table", width: 300, height: 200, renderer: "table", content: { "headers": ["Col A", "Col B"], "rows": [["1", "2"], ["3", "4"]] } })
```

Verify:
```
list('yaar://monitors')   # all 5 windows should appear: si-v-md, si-v-html, si-v-text, si-v-comp, si-v-tbl
```

**PASS** if all 5 windows appear in the list. Then close all:
```
delete('yaar://monitors/0/si-v-md')
delete('yaar://monitors/0/si-v-html')
delete('yaar://monitors/0/si-v-text')
delete('yaar://monitors/0/si-v-comp')
delete('yaar://monitors/0/si-v-tbl')
```
...
```
invoke('yaar://monitors/0/si-v-update', { action: "create", title: "Update Test", renderer: "markdown", content: "Line 1" })
invoke('yaar://monitors/0/si-v-update', { action: "update", operation: "append", content: "\nLine 2" })
read('yaar://monitors/0/si-v-update')          # should contain "Line 1\nLine 2"
invoke('yaar://monitors/0/si-v-update', { action: "update", operation: "prepend", content: "Line 0\n" })
read('yaar://monitors/0/si-v-update')          # should contain "Line 0\nLine 1\nLine 2"
invoke('yaar://monitors/0/si-v-update', { action: "update", operation: "replace", content: "Replaced." })
read('yaar://monitors/0/si-v-update')          # should contain only "Replaced."
delete('yaar://monitors/0/si-v-update')
```
...
```
invoke('yaar://monitors/0/si-v-lock', { action: "create", title: "Lock Test", renderer: "text", content: "Locked window test." })
invoke('yaar://monitors/0/si-v-lock', { action: "lock" })
```
Attempt to update the locked window — it should return a lock error or feedback:
```
invoke('yaar://monitors/0/si-v-lock', { action: "update", operation: "replace", content: "Should fail." })
```
Then unlock and update successfully:
```
invoke('yaar://monitors/0/si-v-lock', { action: "unlock" })
invoke('yaar://monitors/0/si-v-lock', { action: "update", operation: "replace", content: "Unlocked and updated." })
read('yaar://monitors/0/si-v-lock')            # should contain "Unlocked and updated."
delete('yaar://monitors/0/si-v-lock')
```
...
```
invoke('yaar://monitors/0/si-v-form', {
...
```
delete('yaar://monitors/0/si-v-form')
```
...
```
invoke('yaar://monitors/0/si-v-excel', { action: "create", title: "Excel Lite", appId: "excel-lite", renderer: "iframe", content: "yaar://apps/excel-lite" })
```

Wait for App Protocol ready, then query manifest:
```
invoke('yaar://monitors/0/si-v-excel', { action: "app_query" })
```
Verify manifest contains `setCells` command and `cells` state key.

Write test data:
```
invoke('yaar://monitors/0/si-v-excel', { action: "app_command", command: "setCells", params: { "cells": { "A1": "Name", "B1": "Score", "A2": "Alice", "B2": "95", "A3": "Bob", "B3": "87" } } })
```

Read back:
```
invoke('yaar://monitors/0/si-v-excel', { action: "app_query", stateKey: "cells" })
```
Verify cells A1="Name", B1="Score", A2="Alice", B2="95", A3="Bob", B3="87".

Test clearRange:
```
invoke('yaar://monitors/0/si-v-excel', { action: "app_command", command: "clearRange", params: { "start": "A3", "end": "B3" } })
invoke('yaar://monitors/0/si-v-excel', { action: "app_query", stateKey: "cells" })
```
Verify A3 and B3 are now empty/missing, but A1-B2 still intact.

```
delete('yaar://monitors/0/si-v-excel')
```
...
```
invoke('yaar://monitors/0/si-v-word', { action: "create", title: "Word Lite", appId: "word-lite", renderer: "iframe", content: "yaar://apps/word-lite" })
```

Wait for ready, then:
```
invoke('yaar://monitors/0/si-v-word', { action: "app_command", command: "setTitle", params: { "title": "Self Inspection Test" } })
invoke('yaar://monitors/0/si-v-word', { action: "app_command", command: "setHtml", params: { "html": "<h1>Test Document</h1><p>This is a self-inspection test.</p>" } })
invoke('yaar://monitors/0/si-v-word', { action: "app_query", stateKey: "title" })   # should be "Self Inspection Test"
invoke('yaar://monitors/0/si-v-word', { action: "app_query", stateKey: "stats" })    # should have words > 0
invoke('yaar://monitors/0/si-v-word', { action: "app_query", stateKey: "text" })     # should contain "self-inspection test"
delete('yaar://monitors/0/si-v-word')
```
...
```
invoke('yaar://monitors/0/si-v-cross', { action: "create", title: "Cross-App Test", appId: "excel-lite", renderer: "iframe", content: "yaar://apps/excel-lite" })
```

Wait for ready, then import the data you read from storage:
```
invoke('yaar://monitors/0/si-v-cross', { action: "app_command", command: "importWorkbook", params: { "data": <parsed JSON from storage read> } })
invoke('yaar://monitors/0/si-v-cross', { action: "app_query", stateKey: "cells" })
```
Verify A1="Product", B2="9.99".

Cleanup:
```
delete('yaar://monitors/0/si-v-cross')
...
```
invoke('yaar://monitors/0/si-v-dev-verify', { action: "create", title: "Dev Test Verify", appId: "si-v-dev-test", renderer: "iframe", content: "yaar://apps/si-v-dev-test" })
list('yaar://monitors')    # verify window exists
delete('yaar://monitors/0/si-v-dev-verify')
```
...
```
invoke('yaar://config/shortcuts', { label: "SI Verb Test", icon: "🧪", shortcutType: "action", target: "self-inspection-verb test" })
...
```
invoke('yaar://monitors/0/si-v-comp-upd', {
  action: "create_component",
...
```
delete('yaar://monitors/0/si-v-comp-upd')
```
...
```
invoke('yaar://monitors/0/si-v-multi-excel', { action: "create", title: "Multi: Excel", appId: "excel-lite", renderer: "iframe", content: "yaar://apps/excel-lite" })
invoke('yaar://monitors/0/si-v-multi-word', { action: "create", title: "Multi: Word", appId: "word-lite", renderer: "iframe", content: "yaar://apps/word-lite" })
invoke('yaar://monitors/0/si-v-multi-img', { action: "create", title: "Multi: Images", appId: "image-viewer", renderer: "iframe", content: "yaar://apps/image-viewer" })
```

Wait for all 3 to be ready, then interact with each:

```
invoke('yaar://monitors/0/si-v-multi-excel', { action: "app_command", command: "setCells", params: { "cells": { "A1": "Multi-app test" } } })
invoke('yaar://monitors/0/si-v-multi-word', { action: "app_command", command: "setHtml", params: { "html": "<p>Multi-app test</p>" } })
invoke('yaar://monitors/0/si-v-multi-img', { action: "app_command", command: "setLayout", params: { "mode": "grid", "columns": 3 } })
```

Query each to verify:
```
invoke('yaar://monitors/0/si-v-multi-excel', { action: "app_query", stateKey: "cells" })    # A1 = "Multi-app test"
invoke('yaar://monitors/0/si-v-multi-word', { action: "app_query", stateKey: "text" })      # contains "Multi-app test"
invoke('yaar://monitors/0/si-v-multi-img', { action: "app_query", stateKey: "layout" })     # mode = "grid"
```

Close all:
```
delete('yaar://monitors/0/si-v-multi-excel')
delete('yaar://monitors/0/si-v-multi-word')
delete('yaar://monitors/0/si-v-multi-img')
```
...
```
read('yaar://agents/<first-agent-id>')
```
...
```
invoke('yaar://monitors/0/self-inspection-verb-report', {
  action: "create",
