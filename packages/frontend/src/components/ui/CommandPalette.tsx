            ...
            <div className={styles.gearWrapper}>
              ...
              {settingsOpen && (
                <div ref={settingsRef} className={styles.settingsPopover}>
                  ...
                  <button
                    className={styles.settingsItem}
                    onClick={() => { toggleRecentActionsPanel(); setSettingsOpen(false) }}
                  ...
                  <button
                    className={styles.settingsItem}
                    onClick={() => { toggleDebugPanel(); setSettingsOpen(false) }}
