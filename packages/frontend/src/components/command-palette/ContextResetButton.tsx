 ...
 * that slot, and the reset moved up to where reaching it takes a deliberate pull.
 */
...
export function ContextResetButton({ className }: { className?: string }) {
  ...
  return (
    <button className={className} onClick={handleReset} title={t('commandPalette.tooltip.reset')}>
      <svg
        width="16"
        height="16"
        viewBox="0 0 20 20"
